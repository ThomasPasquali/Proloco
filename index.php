    ...
    <div id="background-img">
        ...
        <nav id="menu">
            ...
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="show('webcam');">Webcam</a>
                </li>
        ...
        <div id="content-wrap">
            ...
            <div id="content">
                ...
                <!-- WEBCAM -->
                <div id="webcam" class="hidden subpage">
                    <div>
                        <img src="http://www.agordino.eu/web/canale/foto.jpg" alt="webcam canale d'agordo">

                        <div>
                            <h1><?= $lang['webcam_title'] ?></h1>
                            <a href="https://www.agordino.net/Agordino_Meteo/Home.html" target="_blank">Agordino</a>
                            <a href="https://www.skiareasanpellegrino.it/web-cam-2/" target="_blank">Skiarea San Pellegrino</a>
                        </div>
                    </div>
                </div>
                <!-- END WEBCAM -->
